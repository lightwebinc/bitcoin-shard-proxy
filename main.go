...
import (
	...
	"github.com/jefflightweb/bitcoin-shard-proxy/internal/config"
	"github.com/jefflightweb/bitcoin-shard-proxy/internal/shard"
	"github.com/jefflightweb/bitcoin-shard-proxy/internal/worker"
)
...
func main() {
	...
	engine := shard.New(cfg.MCPrefix, cfg.ShardBits)
