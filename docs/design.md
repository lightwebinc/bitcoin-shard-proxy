...
- NACK retransmission via multicast retry endpoints: wire protocol finalised (56-byte NACK datagram per BRC-122); retry endpoint implementation TBD.
...
- [x] Subtree sharding cross-linking fields in BRC-122 frame header
...
- [x] BRC-122 frame format: 92-byte header, CRC32c SenderID, 4-byte sequence fields
